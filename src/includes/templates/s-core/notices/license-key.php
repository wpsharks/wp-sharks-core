...
<form method="post" action="<?= esc_url($this->s::saveOptionsUrl()) ?>" style="margin:0.5em 0;">
    <input type="text" name="<?= esc_attr($this->s::actionFormElementName('§license_key')) ?>" placeholder="<?= esc_attr(__('enter license key here...', 'wp-sharks-core')) ?>" style="width:400px; max-width:75%;" />
